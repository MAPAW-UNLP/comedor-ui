 ...
 */
@Component({
	selector: 'cu-menu-creation-page-ctrl',
	templateUrl: './menu-creation-page-ctrl.component.html',
	styleUrls: [ './menu-creation-page-ctrl.component.scss' ],
})
export class MenuCreationPageCTRLComponent{
